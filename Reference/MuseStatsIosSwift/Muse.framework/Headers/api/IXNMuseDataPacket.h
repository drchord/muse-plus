 ...
 * \param ppgValue the raw PPG channel value.
 * \return the PPG value in microamps.
 * \exception SIGABRT
 */
- (double)getPpgMicroamps:(IXNMuseModel)model
                 ppgValue:(double)ppgValue;
 ...
 *  to check the type before calling this function.
 */
- (double)getOpticsChannelValue:(IXNOptics)channelNum;
